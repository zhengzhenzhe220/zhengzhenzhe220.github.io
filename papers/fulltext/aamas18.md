...
![](assets/aamas18/aamas18.pdf-0002-10.png)



![](assets/aamas18/aamas18.pdf-0002-11.png)



![](assets/aamas18/aamas18.pdf-0002-12.png)



![](assets/aamas18/aamas18.pdf-0002-13.png)



![](assets/aamas18/aamas18.pdf-0002-14.png)



![](assets/aamas18/aamas18.pdf-0002-15.png)
...
![](assets/aamas18/aamas18.pdf-0003-13.png)


Where _zi_ , _j_ ( _vi_<sup>′)=</sup><sup>_Pr_(</sup><sup>_xi_(b)=</sup><sup>_cj_)denotes the probabilitythat</sup><sup>_i_</sup> obtains _j_ -th slot. This formulation holds true when E[ _pi_ ( _<u>ω</u>_ )] = 0. Then for condition of agent 1, the probability she wins the first slot is _z_ 1,1 ( _v_ 1<sup>′)=</sup> � _N Hl_ ( _v_ 1<sup>′), for the second slot is</sup><sup>_z_1,2=�</sup> (1 − _l_ =2 _k_ �1 _Hk_ ( _v_ 1<sup>′))�</sup> _Hl_ ( _v_ 1<sup>′).... In general,</sup> _l_ �1, _k_ 


![](assets/aamas18/aamas18.pdf-0003-15.png)


And similar derivations for other _zi_ , _j_ . To simplify notation we define a auxiliary function _Qi_ ( _t_ ) = � _K cj_ · _zi_ , _j_ ( _t_ ), then equation (1) _j_ =1 

can be simplified as � _<u>ωvi</u>_ ′ _Qi_ ( _t_ ) _dt_ . With the above derivations, we can now consider _i_ ’s DP strategy. Since _vi_<sup>′is unknown prior to</sup><sup>_si_, we should do expectation of</sup><sup>_ui_in</sup> equation (1) with respect to _vi_<sup>′:</sup> 


![](assets/aamas18/aamas18.pdf-0003-18.png)
...
![](assets/aamas18/aamas18.pdf-0003-20.png)
...
We assume the cost is linear: Φ _i_ ( _αi_ ) = _ϕi_ ( _αi_ − _<u>α</u>_ ), _ϕi_ > 0. From now on we start to consider the problem from agents 1’s point of view. Corresponding to equation (1), the expected utility for 1 at auction stage when truthful report is 


![](assets/aamas18/aamas18.pdf-0004-09.png)
...
![](assets/aamas18/aamas18.pdf-0004-11.png)



![](assets/aamas18/aamas18.pdf-0004-12.png)


And notice that 


![](assets/aamas18/aamas18.pdf-0004-14.png)


And the same form for agents 2. So it can be observed that when _v_ 1 = _v_ 2, we have _πi_ being strictly concave in _αi_ . By Proposition 8.D.3 in [37], since the strategy space for every agents is <u>[</u> _<u>α</u>_ <u>,</u> _~~α~~_ <u>],</u> which is a nonempty, convex and compact subset of Euclidean space, combining with that _πi_ is continuous in ( _α_ 1, _α_ 2) and concave in _αi_ , there exists a Nash equilibrium. □ 
...
![](assets/aamas18/aamas18.pdf-0004-20.png)
...
![](assets/aamas18/aamas18.pdf-0005-04.png)
...
![](assets/aamas18/aamas18.pdf-0005-07.png)
...
![](assets/aamas18/aamas18.pdf-0005-18.png)
...
![](assets/aamas18/aamas18.pdf-0006-15.png)
...
![](assets/aamas18/aamas18.pdf-0006-18.png)
...
![](assets/aamas18/aamas18.pdf-0007-02.png)
...
![](assets/aamas18/aamas18.pdf-0007-05.png)
...
![](assets/aamas18/aamas18.pdf-0007-18.png)



![](assets/aamas18/aamas18.pdf-0007-19.png)
...
![](assets/aamas18/aamas18.pdf-0008-02.png)
...
![](assets/aamas18/aamas18.pdf-0008-05.png)
...
![](assets/aamas18/aamas18.pdf-0008-07.png)
...
![](assets/aamas18/aamas18.pdf-0008-09.png)


Here _д_ 1 ( _H_ ) = _H_ and _д_ 2 ( _H_ ) = 1− _H_ , and _M_ > 0 is a series production of form of 1− _H_ and _H_ independent of 1, 2. The strict log-convex of _H_ is equivalent to that<sup>∂</sup><sup>_H_</sup> ∂<sup>_α_</sup> _α_<sup>_<u>i</u>_</sup> _i_<sup>(</sup><sup>_v_)</sup> _f_ 1 (1 _Hi_ )<sup>is strictly increasing. And</sup> by (9) we can conclude form of<sup>∂</sup><sup>_H_</sup> ∂<sup>_α_</sup> _α_<sup>_<u>i</u>_</sup> _i_<sup>(</sup><sup>_v_)</sup> _f_ 2 (1 _Hi_ )<sup>are also increasing</sup> just by verifying the positiveness of its first derivative on _αi_ : 


![](assets/aamas18/aamas18.pdf-0008-11.png)
...
![](assets/aamas18/aamas18.pdf-0008-13.png)


notice that 


![](assets/aamas18/aamas18.pdf-0008-15.png)
...
![](assets/aamas18/aamas18.pdf-0008-18.png)
...
- [1] Ittai Abraham, Susan Athey, Moshe Babaioff, and Michael Grubb. 2011. _Peaches, Lemons, and Cookies: Designing Auction Markets with Dispersed Information_ . Technical Report. https://www.microsoft.com/en-us/research/publication/ peaches-lemons-and-cookies-designing-auction-markets-with-dispersed-information/ 
